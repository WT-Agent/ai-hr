    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">企业HR面试问题</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 企业面试官与防伪追问</span>
...
// 清理回复末尾的特殊标记 [HR_SCORES]...[/HR_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[HR_SCORES\][\s\S]*?\[\/HR_SCORES\]/gi, '').trim();
});

// 提取面试考察要点与一部分题目作为卡片主体，避免卡片过长
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 面试评估与提问套件】\n\n${cleanContent.value}\n\n体验人才防伪面试大模型：https://ai.wuxian.xyz`;
